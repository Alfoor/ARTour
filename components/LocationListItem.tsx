...
const LocationListItem: React.FC<LocationListItemProps> = ({ location, onSelectLocation }) => {
  return (
    <button
      type="button"
      className="location-card bg-white rounded-lg p-4 shadow-md hover:shadow-lg transition-shadow cursor-pointer transform hover:-translate-y-0.5 text-left w-full"
